...
export default function Ticket() {
  ...
  const handleEliminar = (id) => {
    ...
    fetch(`https://apiticketccgroup.onrender.com/tickets/${id}`, {
      method: "DELETE",
    })
      .then((response) => {
        if (!response.ok) {
        ...
        return fetch("https://apiticketccgroup.onrender.com/tickets");
      })
      .then((response) => response.json())
      .then((data) => {
  ...
  const handleUpdate = async () => {
    try {
      ...
      const response = await fetch(
        `https://apiticketccgroup.onrender.com/tickets/${selectedTicket.id}`,
        {
          method: "PUT",
          headers: {
